...
class ResponseStatus(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _RESPONSESTATUS

  # @@protoc_insertion_point(class_scope:ResponseStatus)

class UploadOperation(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPLOADOPERATION

  # @@protoc_insertion_point(class_scope:UploadOperation)

class ChallengeInfo(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _CHALLENGEINFO

  # @@protoc_insertion_point(class_scope:ChallengeInfo)

class SignedChallengeInfo(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _SIGNEDCHALLENGEINFO

  # @@protoc_insertion_point(class_scope:SignedChallengeInfo)

class TrackSample(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _TRACKSAMPLE

  # @@protoc_insertion_point(class_scope:TrackSample)

class UploadPlaylistRequest(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPLOADPLAYLISTREQUEST

  # @@protoc_insertion_point(class_scope:UploadPlaylistRequest)

class PlaylistResponse(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _PLAYLISTRESPONSE

  # @@protoc_insertion_point(class_scope:PlaylistResponse)

class UploadPlaylistResponse(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPLOADPLAYLISTRESPONSE

  # @@protoc_insertion_point(class_scope:UploadPlaylistResponse)

class UploadPlaylistEntryRequest(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPLOADPLAYLISTENTRYREQUEST

  # @@protoc_insertion_point(class_scope:UploadPlaylistEntryRequest)

class PlaylistEntryResponse(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _PLAYLISTENTRYRESPONSE

  # @@protoc_insertion_point(class_scope:PlaylistEntryResponse)

class UploadPlaylistEntryResponse(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPLOADPLAYLISTENTRYRESPONSE

  # @@protoc_insertion_point(class_scope:UploadPlaylistEntryResponse)

class UploadMetadataRequest(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPLOADMETADATAREQUEST

  # @@protoc_insertion_point(class_scope:UploadMetadataRequest)

class UpdateUploadStateRequest(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPDATEUPLOADSTATEREQUEST

  # @@protoc_insertion_point(class_scope:UpdateUploadStateRequest)

class ClientStateRequest(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _CLIENTSTATEREQUEST

  # @@protoc_insertion_point(class_scope:ClientStateRequest)

class ClientStateResponse(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _CLIENTSTATERESPONSE

  # @@protoc_insertion_point(class_scope:ClientStateResponse)

class UploadMetadataResponse(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPLOADMETADATARESPONSE

  # @@protoc_insertion_point(class_scope:UploadMetadataResponse)

class TrackSampleResponse(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _TRACKSAMPLERESPONSE

  # @@protoc_insertion_point(class_scope:TrackSampleResponse)

class UploadSampleRequest(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPLOADSAMPLEREQUEST

  # @@protoc_insertion_point(class_scope:UploadSampleRequest)

class UploadSampleResponse(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPLOADSAMPLERESPONSE

  # @@protoc_insertion_point(class_scope:UploadSampleResponse)

class ImageUnion(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _IMAGEUNION

  # @@protoc_insertion_point(class_scope:ImageUnion)

class UploadResponse(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPLOADRESPONSE

  # @@protoc_insertion_point(class_scope:UploadResponse)

class TracksToUpload(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _TRACKSTOUPLOAD

  # @@protoc_insertion_point(class_scope:TracksToUpload)

class GetJobsRequest(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _GETJOBSREQUEST

  # @@protoc_insertion_point(class_scope:GetJobsRequest)

class GetJobsResponse(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _GETJOBSRESPONSE

  # @@protoc_insertion_point(class_scope:GetJobsResponse)

class UpAuthRequest(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPAUTHREQUEST

  # @@protoc_insertion_point(class_scope:UpAuthRequest)

class DeleteUploadRequestedRequest(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _DELETEUPLOADREQUESTEDREQUEST

  # @@protoc_insertion_point(class_scope:DeleteUploadRequestedRequest)

class ClientPolicy(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _CLIENTPOLICY

  # @@protoc_insertion_point(class_scope:ClientPolicy)

class UploadMetadataInternalRequest(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _UPLOADMETADATAINTERNALREQUEST

  # @@protoc_insertion_point(class_scope:UploadMetadataInternalRequest)

class OverrideConfigValue(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
  DESCRIPTOR = _OVERRIDECONFIGVALUE

  # @@protoc_insertion_point(class_scope:OverrideConfigValue)

class OverrideConfigValueCollection(with_metaclass(reflection.GeneratedProtocolMessageType, message.Message)):
